...
public class DataBinderMapperImpl extends DataBinderMapper {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_VIEWCARPOOL: {
          if ("layout/view_car_pool_0".equals(tag)) {
            return new ViewCarPoolBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for view_car_pool is invalid. Received: " + tag);
        }
      }
    }
    return null;
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.stonetree.restclient.DataBinderMapperImpl());
    result.add(new com.stonetree.view.DataBinderMapperImpl());
    return result;
  }
